...
Python script that is to grab all the articles from the source: Northwest News Network,
specifically from Northwest News Network's government and politics section.
...
Usage:
    ...
    python grabber_nw_news_network.py [ current_time ]
...
def main(current_time):
    ...
    # print "\n"
    article = Article('http://nwnewsnetwork.org/category/government-and-politics')
    article.download()
