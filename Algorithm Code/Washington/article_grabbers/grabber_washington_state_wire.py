...
Python script that is to grab all the articles from the source: Washington State Wire.
...
Usage:
    ...
    python grabber_washington_state_wire.py [ current_time ]
...
def main(current_time):
    # print "\n"
    # print "\n"
    # print "Washington State Wire"
    # print "\n"
    article = Article('https://washingtonstatewire.com/category/news/')
    article.download()
    soups = BeautifulSoup(article.html)
    tempList = []
    tempListud = {}
    articleTime = current_time[:]
    # prefix = "https://washingtonstatewire.com/"
